    ...
    async function loadAll() {
      try {
        const [
          ...
          // Real-time data → Analyser → Predictor
          analyseFloodConditions({
            rainfall: 70,
            water_level: 0.35,
        ...
        // Forecast generated by Predictor
        const backendTimeline = analyserResult.forecast;

        // Real-time analysis generated by Analyser
        setAnalysis(analyserResult.analysis);
        ...
        const dashboardTimeline = selectedForecast.map((step) => {
          ...
          return {
            ...
            /*
             * Predictor drainage utilisation.
             * Example:
             * 1.67 = 167%
             */
            ...
            /*
             * Use real-time analyser data.
             * The analyser values are especially
             * relevant for the NOW state.
             */
            waterLevel:
              analyserResult.analysis.water_level_smoothed,
